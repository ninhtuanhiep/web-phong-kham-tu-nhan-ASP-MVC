...
builder.Services.AddScoped<web_phong_kham_tu_nhan.Services.ThongBaoService>();
builder.Services.AddHostedService<web_phong_kham_tu_nhan.Services.NhacLichBackgroundService>();
