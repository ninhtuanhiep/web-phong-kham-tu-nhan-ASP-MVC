...
namespace web_phong_kham_tu_nhan.Controllers
{
    public class AccountController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Dangky(string email, string password, string fullName, string phoneNumber)
        {
            ...
            string mkPlainText = password; // lưu trước khi hash
            ...
            // Gửi email chào mừng — thất bại vẫn redirect bình thường
            try
            {
            ...
            {
                Console.WriteLine($"[Email Warning] {ex.ToString()}");
                TempData["EmailError"] = ex.Message; // hiện tạm lên màn hình
                throw; // ném lỗi ra để thấy rõ
            }
